  ...
  <?php
    ...
    wp_enqueue_script( 'bootsrap', get_template_directory_uri().'/vendor/bootstrap/js/bootstrap.bundle.min.js', array(), false, true );
    wp_enqueue_script( 'jQuery-slick', 'https://cdn.jsdelivr.net/jquery.slick/1.4.1/slick.min.js', array(), false, true );
    wp_enqueue_script( 'slick', get_template_directory_uri().'/vendor/jquery/slick.js', array(), false, true );
  ?>
  <?php wp_footer(); ?>
</body>
</html>
